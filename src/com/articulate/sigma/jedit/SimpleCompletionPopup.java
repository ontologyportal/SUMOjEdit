        ...
        try {
            ...
            jlist.addKeyListener(new java.awt.event.KeyAdapter() {
                @Override public void keyPressed(java.awt.event.KeyEvent e) {
                    ...
                    if (code == java.awt.event.KeyEvent.VK_ENTER) accept(ta, prefix, jlist.getSelectedValue());
                    else if (code == java.awt.event.KeyEvent.VK_ESCAPE) dismiss();
                    else if (code == java.awt.event.KeyEvent.VK_TAB) accept(ta, prefix, jlist.getSelectedValue());
                    e.consume();
                }
            });
